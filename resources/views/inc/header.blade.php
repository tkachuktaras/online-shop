<header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
    ...
    @if(Auth::user()->is_admin == 1)
        <div class="col-md-4 text-end">
            <button type="button" onclick="window.location.href='{{ route('dashboard') }}'" class="btn btn-outline-danger">
    ...
    @else
        <div class="col-md-3 text-end">
    @endif
        <button type="button" onclick="window.location.href='{{ route('basket') }}'" class="btn btn-outline-success">
            ...
            Basket(<span class="basket_qty">{{ \Cart::session(Auth::id())->getTotalQuantity() }}</span>)
        </button>
